  ...
  return (
    <div className='flex flex-col justify-center items-center mt-20'>
      ...
      <p className='my-10 mx-140 tracking-wide font-light leading-relaxed'>
        ...
        <ul className='list-disc my-10 mx-16'>
          <li className='mb-5'>
            Clases Presenciales: Disponibles para estudiantes de infantil,
            primaria, secundaria y bachillerato en la provincia de Sevilla.
            Estas clases permiten una inmersión completa en el aprendizaje
            islámico, proporcionando un entorno enriquecedor donde los alumnos
            pueden interactuar y aprender de manera directa con sus profesores y
            compañeros.
          </li>
          <li>
            Clases Online: Ofrecemos un programa online dirigido a estudiantes
            de primaria y secundaria, asegurando que todos tengan acceso a una
